...
void create_animations(GAME_DATA *game_data, GAME_ANIM *game_anim)
{
    ...
    //ACTION TILES
    Texture2D tiles_backlight_textur = game_anim->texturs->world_texturs->tiles_texturs->action_tiles_texturs->tiles_backlight;
    Texture2D tiles_backlight_glow_effect_textur = game_anim->texturs->world_texturs->tiles_texturs->action_tiles_texturs->tiles_backlight_glow_effect;
    Animation tiles_backlight_animation = create_animation(tiles_backlight_textur, Width, 1, 64, 64, (Rectangle){0, 0, 64, 64}, 8, alloc);
    Animation tiles_backlight_glow_effect_animation_1 = create_animation(tiles_backlight_glow_effect_textur, Width, 4, 64, 64, (Rectangle){0, 0, 64, 64}, 8, alloc);
    Animation tiles_backlight_glow_effect_animation_2 = create_animation(tiles_backlight_glow_effect_textur, Width, 4, 64, 64, (Rectangle){64, 0, 64, 64}, 8, alloc);
    Animation tiles_backlight_glow_effect_animation_3 = create_animation(tiles_backlight_glow_effect_textur, Width, 4, 64, 64, (Rectangle){128, 0, 64, 64}, 8, alloc);
    Animation tiles_backlight_glow_effect_animation_4 = create_animation(tiles_backlight_glow_effect_textur, Width, 4, 64, 64, (Rectangle){192, 0, 64, 64}, 8, alloc);
    game_anim->animations->world_animation->tiles_animation->action_tiles_animations->tiles_backlight_animation = tiles_backlight_animation;
    game_anim->animations->world_animation->tiles_animation->action_tiles_animations->tiles_backlight_glow_effect_animation_1 = tiles_backlight_glow_effect_animation_1;
    game_anim->animations->world_animation->tiles_animation->action_tiles_animations->tiles_backlight_glow_effect_animation_2 = tiles_backlight_glow_effect_animation_2;
    game_anim->animations->world_animation->tiles_animation->action_tiles_animations->tiles_backlight_glow_effect_animation_3 = tiles_backlight_glow_effect_animation_3;
    game_anim->animations->world_animation->tiles_animation->action_tiles_animations->tiles_backlight_glow_effect_animation_4 = tiles_backlight_glow_effect_animation_4;
    //TILES LINE
    Texture2D tiles_backlight_line_textur = game_anim->texturs->world_texturs->tiles_texturs->action_tiles_texturs->tiles_backlight_line;
    Animation tiles_backlight_line_animation_1 = create_animation(tiles_backlight_line_textur, Width, 4, 64, 64, (Rectangle){0, 0, 64, 64}, 8, alloc);
    Animation tiles_backlight_line_animation_2 = create_animation(tiles_backlight_line_textur, Width, 4, 64, 64, (Rectangle){64, 0, 64, 64}, 8, alloc);
    Animation tiles_backlight_line_animation_3 = create_animation(tiles_backlight_line_textur, Width, 4, 64, 64, (Rectangle){128, 0, 64, 64}, 8, alloc);
    Animation tiles_backlight_line_animation_4 = create_animation(tiles_backlight_line_textur, Width, 4, 64, 64, (Rectangle){192, 0, 64, 64}, 8, alloc);
    game_anim->animations->world_animation->tiles_animation->action_tiles_animations->tiles_backlight_line_animation_1 = tiles_backlight_line_animation_1;
    game_anim->animations->world_animation->tiles_animation->action_tiles_animations->tiles_backlight_line_animation_2 = tiles_backlight_line_animation_2;
    game_anim->animations->world_animation->tiles_animation->action_tiles_animations->tiles_backlight_line_animation_3 = tiles_backlight_line_animation_3;
    game_anim->animations->world_animation->tiles_animation->action_tiles_animations->tiles_backlight_line_animation_4 = tiles_backlight_line_animation_4;
    // EXP
    ...
    //ATTACKS
    Texture2D weapon_attacks = game_anim->texturs->effects_texturs->weapon_effects->weapon_attacks;
    Animation attack_enemies_animation = create_animation(weapon_attacks, Width, 3, 24, 24, (Rectangle){72, 0, 24, 24}, 3, alloc);
    game_anim->animations->enemies_animation->attack_enemies_animation = attack_enemies_animation;
    // PLAYER HUMAN ANIM
...
Animations *create_animations_struct(Allocator *alloc)
{
    ...
    ActionTilesAnimations *action_tiles_animations = alloc_alloc(alloc, sizeof(ActionTilesAnimations));
    animation->world_animation->tiles_animation->action_tiles_animations = action_tiles_animations;
    HumanAttacksAnimations  *human_attacks_animations = alloc_alloc(alloc, sizeof(HumanAttacksAnimations ));

    animation->player_animation->human_attacks_animations = human_attacks_animations;
